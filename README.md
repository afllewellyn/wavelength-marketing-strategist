...
- **Real ad-platform targeting data** (Meta, Google Ads, Pinterest, TikTok): verify LLM-suggested interests against each platform's live targeting catalog using read-only, operator-owned API credentials. See [docs/PRD-real-targeting-data.md](docs/PRD-real-targeting-data.md).
